    ...
    <div className="space-y-4 my-2 font-sans">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-dark-surface/60 border border-emerald-500/20 space-y-3 flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono text-emerald-400 uppercase font-bold tracking-widest bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">
                STATIC CAROUSEL
              </span>
            ...
            <div className="h-32 rounded-xl bg-gradient-to-br from-emerald-950/60 to-dark-bg border border-emerald-500/30 p-4 flex flex-col justify-between text-center relative overflow-hidden">
              ...
              <p className="text-[11px] font-mono text-emerald-400 uppercase font-bold">#DesherChabiAponarHate</p>
              <h4 className="text-sm font-bold font-serif text-white">"কেন ঢাকাতেই সব? আপনার জেলাও হতে পারে দেশের পাওয়ারহাউস!"</h4>
              <p className="text-[10px] text-gray-400">Swipe to see Divisional Potential →</p>
            </div>

            <div>
              <h4 className="text-xs font-bold text-white">Facebook & IG Info Carousel</h4>
        ...
        <div className="p-5 rounded-2xl bg-dark-surface/60 border border-sky-500/20 space-y-3 flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono text-sky-400 uppercase font-bold tracking-widest bg-sky-500/10 px-2 py-0.5 rounded border border-sky-500/20">
            ...
            <div className="h-32 rounded-xl bg-gradient-to-br from-sky-950/60 to-dark-bg border border-sky-500/30 p-4 flex flex-col justify-between text-center relative overflow-hidden">
              ...
              <p className="text-[10px] font-mono text-red-400 font-bold uppercase">LIVE TICKER OVC</p>
              <h4 className="text-xs font-bold font-sans text-white">"ঢাকার ৩ ঘণ্টা জ্যাম নাকি নিজের জেলায় বুয়েট ব্রাঞ্চ?"</h4>
              <p className="text-[10px] text-sky-400 font-bold">15-Sec Motion Video</p>
            </div>

            <div>
              <h4 className="text-xs font-bold text-white">Short Video Motion Spot</h4>
              <p className="text-[11px] text-gray-300 mt-1 leading-normal">
        ...
        <div className="p-5 rounded-2xl bg-dark-surface/60 border border-purple-500/20 space-y-3 flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono text-purple-400 uppercase font-bold tracking-widest bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/20">
                COPYWRITING FORMULA
              </span>
            ...
            <div className="p-3 rounded-xl bg-white/5 border border-white/5 space-y-2 text-xs">
              ...
              <p className="text-white font-serif italic text-sm font-semibold">"আমাদের গ্রাম, আমাদের ভবিষ্যত — সুযোগ ছড়াক ৬৪ জেলায়!"</p>
              <div className="flex flex-wrap gap-1 text-[9px] font-mono text-purple-400">
            ...
            <div>
              <h4 className="text-xs font-bold text-white">Emotional Hook & Advocacy Copy</h4>
              <p className="text-[11px] text-gray-300 mt-1 leading-normal">
